...
public:
	...
	size_t get_max_local_worksize(const size_t type_size) const { return std::min(static_cast<size_t>(_max_workgroup_size),
                static_cast<size_t>(_local_mem_size / type_size));
 }
