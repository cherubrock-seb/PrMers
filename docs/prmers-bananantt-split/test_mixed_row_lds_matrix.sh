...
CENTER_SPLIT_F48_61=${CENTER_SPLIT_F48_61:-}
CENTER_SPLIT_F48_31=${CENTER_SPLIT_F48_31:-}
CENTER_F48_DELAYED_SCALE=${CENTER_F48_DELAYED_SCALE:-}
CENTER_REGA_61=${CENTER_REGA_61:-}
CENTER_PRIVATE_A_61=${CENTER_PRIVATE_A_61:-}
CENTER_TWINLINE_61=${CENTER_TWINLINE_61:-}
CENTER_F48_TWIN_SYMMETRY=${CENTER_F48_TWIN_SYMMETRY:-}
CENTER_F48_TWIN_SYMMETRY_61=${CENTER_F48_TWIN_SYMMETRY_61:-}
CENTER_F48_TWIN_SYMMETRY_31=${CENTER_F48_TWIN_SYMMETRY_31:-}
CENTER_F48_DELAYED_SCALE_61=${CENTER_F48_DELAYED_SCALE_61:-}
CENTER_F48_DELAYED_SCALE_31=${CENTER_F48_DELAYED_SCALE_31:-}
CENTER_F48_LATE_SCALE=${CENTER_F48_LATE_SCALE:-}
CENTER_F48_LATE_SCALE_61=${CENTER_F48_LATE_SCALE_61:-}
CENTER_F48_LATE_SCALE_31=${CENTER_F48_LATE_SCALE_31:-}
...

{
  ...
  echo "# CENTER_SPLIT_F48_61=$CENTER_SPLIT_F48_61 CENTER_SPLIT_F48_31=$CENTER_SPLIT_F48_31 CENTER_REGA_61=$CENTER_REGA_61 CENTER_PRIVATE_A_61=$CENTER_PRIVATE_A_61 CENTER_TWINLINE_61=$CENTER_TWINLINE_61"
  echo "# CENTER_F48_TWIN_SYMMETRY=$CENTER_F48_TWIN_SYMMETRY CENTER_F48_TWIN_SYMMETRY_61=$CENTER_F48_TWIN_SYMMETRY_61 CENTER_F48_TWIN_SYMMETRY_31=$CENTER_F48_TWIN_SYMMETRY_31"
  echo "# CENTER_F48_DELAYED_SCALE=$CENTER_F48_DELAYED_SCALE CENTER_F48_DELAYED_SCALE_61=$CENTER_F48_DELAYED_SCALE_61 CENTER_F48_DELAYED_SCALE_31=$CENTER_F48_DELAYED_SCALE_31"
  echo "# CENTER_F48_LATE_SCALE=$CENTER_F48_LATE_SCALE CENTER_F48_LATE_SCALE_61=$CENTER_F48_LATE_SCALE_61 CENTER_F48_LATE_SCALE_31=$CENTER_F48_LATE_SCALE_31"
  echo "# STAGES=$STAGES"
...
for FUSE in $FUSE_BOTHS; do
  for STAGE in $STAGES; do
    for CENTER in $CENTERS; do
      ...
      [[ -n "$CENTER_SPLIT_F48_61" ]] && ENVARGS+=("PRMERS_CRT_MIXED_CENTER_SPLIT_F48_61=$CENTER_SPLIT_F48_61")
      [[ -n "$CENTER_SPLIT_F48_31" ]] && ENVARGS+=("PRMERS_CRT_MIXED_CENTER_SPLIT_F48_31=$CENTER_SPLIT_F48_31")
      [[ -n "$CENTER_F48_DELAYED_SCALE" ]] && ENVARGS+=("PRMERS_CRT_MIXED_CENTER_F48_DELAYED_SCALE=$CENTER_F48_DELAYED_SCALE")
      [[ -n "$CENTER_REGA_61" ]] && ENVARGS+=("PRMERS_CRT_MIXED_CENTER_REGA_61=$CENTER_REGA_61")
      [[ -n "$CENTER_PRIVATE_A_61" ]] && ENVARGS+=("PRMERS_CRT_MIXED_CENTER_PRIVATE_A_61=$CENTER_PRIVATE_A_61")
      [[ -n "$CENTER_TWINLINE_61" ]] && ENVARGS+=("PRMERS_CRT_MIXED_CENTER_TWINLINE_61=$CENTER_TWINLINE_61")
      [[ -n "$CENTER_F48_TWIN_SYMMETRY" ]] && ENVARGS+=("PRMERS_CRT_MIXED_CENTER_F48_TWIN_SYMMETRY=$CENTER_F48_TWIN_SYMMETRY")
      [[ -n "$CENTER_F48_TWIN_SYMMETRY_61" ]] && ENVARGS+=("PRMERS_CRT_MIXED_CENTER_F48_TWIN_SYMMETRY_61=$CENTER_F48_TWIN_SYMMETRY_61")
      [[ -n "$CENTER_F48_TWIN_SYMMETRY_31" ]] && ENVARGS+=("PRMERS_CRT_MIXED_CENTER_F48_TWIN_SYMMETRY_31=$CENTER_F48_TWIN_SYMMETRY_31")
      [[ -n "$CENTER_F48_DELAYED_SCALE_61" ]] && ENVARGS+=("PRMERS_CRT_MIXED_CENTER_F48_DELAYED_SCALE_61=$CENTER_F48_DELAYED_SCALE_61")
      [[ -n "$CENTER_F48_DELAYED_SCALE_31" ]] && ENVARGS+=("PRMERS_CRT_MIXED_CENTER_F48_DELAYED_SCALE_31=$CENTER_F48_DELAYED_SCALE_31")
      [[ -n "$CENTER_F48_LATE_SCALE" ]] && ENVARGS+=("PRMERS_CRT_MIXED_CENTER_F48_LATE_SCALE=$CENTER_F48_LATE_SCALE")
      [[ -n "$CENTER_F48_LATE_SCALE_61" ]] && ENVARGS+=("PRMERS_CRT_MIXED_CENTER_F48_LATE_SCALE_61=$CENTER_F48_LATE_SCALE_61")
      [[ -n "$CENTER_F48_LATE_SCALE_31" ]] && ENVARGS+=("PRMERS_CRT_MIXED_CENTER_F48_LATE_SCALE_31=$CENTER_F48_LATE_SCALE_31")
